...
public class CreerCompteEtudientView extends JFrame implements ActionListener {
    ...
    public CreerCompteEtudientView(AdminControler controler) {
        ...
        lbIMsgC.setBounds(50, 270, 200, 25);
        ...
        btnAnnuler.addActionListener(this::actionPerformed);
        btnValider.addActionListener(this::actionPerformed);
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnValider)) {
            if (controler.creerCompteEtudiant(
                    identifiant.getText(),
                    mdp.getText(),
                    email.getText(),
                    nom.getText(),
        ...
        if (e.getSource().equals(btnAnnuler)) {
            dispose();
            ConsulterCompte am = new ConsulterCompte(controler);
            am.setVisible(true);
        }
    }
